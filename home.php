    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-sm-9">
          ...
          <p>There are many advantages to freelancing, such as the freedom and flexibility it affords. You can often set your own hours and work from home, which can be great if you have young children or other commitments. Additionally, you get to choose the projects you work on, so you can follow your interests and passions.</p>
        </div>
  ...
  <div class="container">
        <div class="row">
      <div class="col-md-12">
        <div class="aligncenter"><h2 class="aligncenter">Popular projects in your area</h2><!-- Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, doloribus omnis minus ovident, doloribus omnis minus temporibus perferendis nesciunt.. --></div>
        <br/>
      </div>
    </div>
        ...
        <div class="col-md-12 ">
          <?php 
            ...
            foreach ($cur as $result) {
              echo '<div class="col-md-3" style="font-size:15px;padding:5px">* <a href="'.web_root.'index.php?q=category&search='.$result->FNAME.'">'.$result->FNAME.'</a></div>';
            }
