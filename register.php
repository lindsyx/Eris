...
<!-- placeholder for old code			      <input  class="form-control input-sm" id="DEGREE" name="DEGREE" placeholder="Educational Attainment"    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"> -->
			      </div>
			  </div>
			</div>  
			<div class="form-group">
